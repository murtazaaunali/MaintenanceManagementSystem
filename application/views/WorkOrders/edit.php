                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div class="form-group">
                            ...
                            <?php echo form_input('workorder_title', set_value('workorder_title', $workorder->title), array('class' => 'span12', 'placeholder' => 'Work order title*')) ?>
                        </div>
                        <div class="form-group">
                            <?php echo form_textarea('workorder_title', set_value('workorder_tittle', $workorder->description), array('class' => 'span12', 'placeholder' => 'Detailed description', 'rows' => '3')); ?>
                        </div>
