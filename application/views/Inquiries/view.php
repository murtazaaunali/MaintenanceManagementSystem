                                ...
                                <div class="tab-pane active" id="panel-168166">
                                    <div class="row clearfix">
                                        ...
                                        <div class="form-group">
                                            <?php echo form_label('Requires Signature', 'inquiry_requires_signature', array('class' => 'control-label')); ?>
                                        </div>
                                        <div class="form-group">
                                            <label class="switch">
                                                <input type="checkbox" name="inquiry_requires_signature" <?php echo set_value('inquiry_requires_signature', $inquiry->requires_sign) == 1 ? 'checked' : '' ?>>
